...
namespace PZone.Samples
{
    ...
    {
        /// <summary>
        /// Устновка значения текстового поля с использованием шрифта, определенного для этого поля или первого подходящего шрифта, при невозможности использования шрифта поля..
        /// </summary>
