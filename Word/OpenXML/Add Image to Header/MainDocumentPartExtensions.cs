...
namespace PZone.Samples
{
    public static class MainDocumentPartExtensions
    {
        ...
        public static Drawing CreateElement(this OpenXmlPart mainDocPart, ImagePart imagePart, string name, long width, long height, string horizontalAlignment = "left", long top = 0, long left = 0, long right = 0)
        {
